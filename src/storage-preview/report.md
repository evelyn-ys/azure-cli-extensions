...
|---------|------------|--------|
|az storage local-user|LocalUsers|[commands](#CommandsInLocalUsers)|

## COMMANDS
### <a name="CommandsInLocalUsers">Commands in `az storage local-user` group</a>
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az storage local-user list](#LocalUsersList)|List|[Parameters](#ParametersLocalUsersList)|[Example](#ExamplesLocalUsersList)|
|[az storage local-user show](#LocalUsersGet)|Get|[Parameters](#ParametersLocalUsersGet)|[Example](#ExamplesLocalUsersGet)|
|[az storage local-user create](#LocalUsersCreateOrUpdate#Create)|CreateOrUpdate#Create|[Parameters](#ParametersLocalUsersCreateOrUpdate#Create)|[Example](#ExamplesLocalUsersCreateOrUpdate#Create)|
|[az storage local-user update](#LocalUsersCreateOrUpdate#Update)|CreateOrUpdate#Update|[Parameters](#ParametersLocalUsersCreateOrUpdate#Update)|[Example](#ExamplesLocalUsersCreateOrUpdate#Update)|
|[az storage local-user delete](#LocalUsersDelete)|Delete|[Parameters](#ParametersLocalUsersDelete)|[Example](#ExamplesLocalUsersDelete)|
|[az storage local-user list-key](#LocalUsersListKeys)|ListKeys|[Parameters](#ParametersLocalUsersListKeys)|[Example](#ExamplesLocalUsersListKeys)|


## COMMAND DETAILS

### group `az storage local-user`
#### <a name="LocalUsersList">Command `az storage local-user list`</a>
...
#### <a name="LocalUsersGet">Command `az storage local-user show`</a>
...
#### <a name="LocalUsersCreateOrUpdate#Create">Command `az storage local-user create`</a>

##### <a name="ExamplesLocalUsersCreateOrUpdate#Create">Example</a>
```
az storage local-user create --account-name "sto2527" --permission-scopes permissions="rwd" resource-name="share1" \
service="file" --permission-scopes permissions="r" resource-name="share2" service="file" --resource-group "res6977" \
--username "user1"
```
...
#### <a name="LocalUsersCreateOrUpdate#Update">Command `az storage local-user update`</a>
...
#### <a name="LocalUsersDelete">Command `az storage local-user delete`</a>
...
#### <a name="LocalUsersListKeys">Command `az storage local-user list-key`</a>
