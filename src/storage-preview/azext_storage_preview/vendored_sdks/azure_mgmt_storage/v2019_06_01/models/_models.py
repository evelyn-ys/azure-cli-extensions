...
class LocalUser(Resource):
    ...
    :type permission_scopes: list[~azure.mgmt.storage.v2019_06_01.models.PermissionScope]
    ...
    :type ssh_authorized_keys: list[~azure.mgmt.storage.v2019_06_01.models.SshPublicKey]
...
class LocalUsers(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.storage.v2019_06_01.models.LocalUser]
    """
