...
def load_arguments(self, _):
    ...
    with self.argument_context('storage local-user list') as c:
    ...
    with self.argument_context('storage local-user show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the storage account within the specified resource '
                   'group. Storage account names must be between 3 and 24 characters in length and use numbers and '
        ...
        c.argument('username', type=str, help='The name of local user. The username must contain lowercase letters and '
                   'numbers only. It must be unique only within the storage account.', id_part='child_name_1')

    with self.argument_context('storage local-user create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the storage account within the specified resource '
                   'group. Storage account names must be between 3 and 24 characters in length and use numbers and '
                   'lower-case letters only.')
        ...
        c.argument('permission_scopes', action=AddPermissionScopes, nargs='+', help='The permission scopes of the '
                   'local user.')
        c.argument('home_directory', type=str, help='Optional, local user home directory.')
        c.argument('ssh_authorized_keys', action=AddSshAuthorizedKeys, nargs='+', help='Optional, local user ssh '
                   'authorized keys for SFTP.')

    with self.argument_context('storage local-user update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the storage account within the specified resource '
                   'group. Storage account names must be between 3 and 24 characters in length and use numbers and '
                   'lower-case letters only.', id_part='name')
    ...
    with self.argument_context('storage local-user delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the storage account within the specified resource '
                   'group. Storage account names must be between 3 and 24 characters in length and use numbers and '
                   'lower-case letters only.', id_part='name')
    ...
    with self.argument_context('storage local-user list-key') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the storage account within the specified resource '
                   'group. Storage account names must be between 3 and 24 characters in length and use numbers and '
                   'lower-case letters only.')
